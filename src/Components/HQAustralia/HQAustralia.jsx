...
import "../HQStyles/HQStyles.css";

export default function HQAustralia() {
  return (
    <div className="hq-location au">
      ...
      <h2 className="hq-location__title">Australia</h2>
      <div className="hq-location__address">
        36 Swanston Street
        <br />
        Kewell
        <br />
